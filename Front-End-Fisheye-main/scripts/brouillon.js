class DetailPhotographerView {
  constructor() {
    ...
    this.currentPhotographer = null; // Ajout de la propriété pour stocker le photographe
...
openLightbox(index) {
  ...
  const photographer = this.currentPhotographer; // Utilisez le photographe actuellement sélectionné
  ...
  showNextMedia() {
    if (this.currentMediaIndex < this.totalMedia.length - 1) {
      ...
      this.openLightbox(this.currentMediaIndex, photographer);
    }
  }
